...
import GraphCreatInfoPercen from "./Graph/GraphCreatInfoPercen";
import GraphGroupByWeek from "./Graph/GraphGroupByWeek";
import GraphGroupByMonth from "./Graph/GraphGroupByMonth";
...
function Dashboard() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-customer`,
    fetcher
  );
  const {
    data: countPartner,
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-admin`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-partner-group-type-allday`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-partner-group-type-round`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-partner-verification`,
    fetcher
  );
  const {
    data: partnerApprove,
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-partner-approve`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD_ADMIN}/get-count-partner-disapprove`,
    fetcher
  );
  if (
    errorCustomer ||
          ...
          <div className="col-span-6 grid grid-rows-4 gap-4  rounded-lg">
            ...
            <div className="row-span-2   w-full   bg-white rounded-md ">
              ...
              <div className="  flex justify-center">
                <GraphCreatInfoPercen countPartner={countPartner} />
              </div>
            </div>
          </div>
