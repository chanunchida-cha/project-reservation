...
function GraphRoundGroupByDay() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-for-day/${id}`,
    fetcher
  );
  ...
  dataSets = sortLabelsDay.filter((label) => {
    let found = false;
...
export default GraphRoundGroupByDay;
