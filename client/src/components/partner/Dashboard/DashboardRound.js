...
import GraphRoundGroupByDay from "./GraphRound/GraphRoundGroupByDay";
import GraphRoundGroupByWeek from "./GraphRound/GraphRoundGroupByWeek";
import GraphRoundGroupByMonth from "./GraphRound/GraphRoundGroupByMonth";
import GraphRoundGroupByYear from "./GraphRound/GraphRoundGroupByYear";
...
function DashboardRound() {
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-today/${id}`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv/${id}`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-for-last-week/${id}`,
    fetcher
  );
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-for-next-week/${id}`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-pending/${id}`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-arrived/${id}`,
    fetcher
  );
  ...
  const {
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-checkout/${id}`,
    fetcher
  );
  const {
    data: cancel,
    ...
    `${process.env.REACT_APP_API_DASHBOARD}/get-count-round-reserv-cancel/${id}`,
    fetcher
  );

  console.log("countAllReserv");
  if (
    errorAllReserv ||
    errorTodayReserv ||
    errorReservLastWeek ||
        ...
        <div className="col-span-3 bg-[#85b1fea4] shadow-md px-3 py-4 rounded-lg">
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-1 flex justify-end">
              {countTodayReserv.count === undefined
                ? "0"
                : countTodayReserv.count}
            </div>
          </div>
        </div>
        <div className="col-span-3 bg-[#85b1fea4] shadow-md px-3 py-4 rounded-lg">
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-1 flex justify-end">
              {countReservLastWeek.count === undefined
                ? "0"
                : countReservLastWeek.count}
            </div>
          </div>
        </div>
        <div className="col-span-3 bg-[#85b1fea4] shadow-md px-3 py-4 rounded-lg">
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-1 flex justify-end">
              {countReservNextWeek.count === undefined
                ? "0"
                : countReservNextWeek.count}
            </div>
          </div>
        </div>
        <div className="col-span-3 bg-[#85b1fea4] shadow-md px-3 py-4 rounded-lg">
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-1 flex justify-end">
              {countAllReserv.count === undefined ? "0" : countAllReserv.count}
            </div>
          </div>
        </div>
      </div>
      <div>
        <div className="mt-2 grid grid-cols-12 grid-rows-2 gap-4  rounded-md px-4 py-4">
              ...
              <div className="grid grid-cols-4 gap-2 mt-2">
                <div className="bg-[#5292ff4e] px-2 py-4 rounded-md ">
                  <div className="grid grid-cols-4">
                    ...
                    <div className="col-span-1 flex justify-end">
                      {pending.count === undefined ? "0" : pending.count}
                    </div>
                  </div>
                </div>
                <div className="bg-[#ffd485a1] px-2 py-4 rounded-md ">
                  <div className="grid grid-cols-4">
                    ...
                    <div className="col-span-1 flex justify-end">
                      {arrived.count === undefined ? "0" : arrived.count}
                    </div>
                  </div>
                </div>
                <div className="bg-[#a29ee2c7] px-2 py-4 rounded-md ">
                  <div className="grid grid-cols-4">
                    ...
                    <div className="col-span-1 flex justify-end">
                      {checkOut.count === undefined ? "0" : checkOut.count}
                    </div>
                  </div>
                </div>
                <div className="bg-[#e18eac95]  px-2 py-4 rounded-md ">
                  <div className="grid grid-cols-4">
                    ...
                    <div className="col-span-1 flex justify-end">
                      {cancel.count === undefined ? "0" : cancel.count}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-span-6 bg-white px-3  py-4 rounded-lg overflow-x-auto">
            ...
            <div className="mt-2">
              {type === "รายวัน" ? (
                <GraphRoundGroupByDay />
              ) : type === "รายสัปดาห์" ? (
                <GraphRoundGroupByWeek />
              ) : type === "รายเดือน" ? (
                <GraphRoundGroupByMonth />
              ) : (
                <GraphRoundGroupByYear />
              )}
            </div>
          </div>
        </div>
