...
import ReservRoundTodayData from "./ReservRoundTodayData";
import ReservRoundAllData from "./ReservRoundAllData";
...
function ReservRoundData() {
  ...
  return (
    <div>
      ...
      {selected.key === "todayReserv" && <ReservRoundTodayData/>}
      {selected.key === "allReserv" && <ReservRoundAllData />}
    </div>
  );
}

export default ReservRoundData;
