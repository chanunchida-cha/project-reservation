...
const Login = observer(() => {
  ...
  return (
    ...
    <div className="max-w-full w-full space-y-10  mx-10   overflow-hidden  sm:rounded-lg sm:mx-40 p-6">
      <div>
        <h4 className="mt-6 text-center text-2xl font-semibold text-gray-900">
          เข้าสู่ระบบ
        </h4>
      </div>
